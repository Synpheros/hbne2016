...
public class Plot_Map_Firstentry : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sequence.Add(new SequenceNode("Tú: Ésta chica lleva a ropa de danza como yo...", new int[] { -1, -1, 0 }));
        ...
        sequence.Add(new SequenceNode("Tú: ¡Estupendo! Yo también voy a practicar claquet.", new int[] { -1, -1, 0 }));
        sequence.Add(new SequenceNode("Tú: ¿Cómo te llamas?", new int[] { -1, -1, 0 }));
        sequence.Add(new SequenceNode("Alicia: Alicia.", new int[] { 1, -1, -1 }));
        sequence.Add(new SequenceNode("Tú: ¡Encantado Alicia!", new int[] { -1, -1, 0 }));
