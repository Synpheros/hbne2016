...
public class Plot_Director_Bailarinprincipal : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sequence.Add(new SequenceNode("Tú: Por cierto, esta tarde voy a dar un paseo por el centro... podrías acompañarme", new int[] { 0, -1, -1 }));
        sequence.Add(new SequenceNode("Alicia: ¡De acuerdo!", new int[] { -1, 1, -1 }));
        sequence.Add(new SequenceNode("Tú: Estupendo", new int[] { 0, -1, -1 }));
        sequence.Add(new SequenceNode("Tú: ...el director se está preparando para anunciar algo...", new int[] { 0, -1, -1 }));
